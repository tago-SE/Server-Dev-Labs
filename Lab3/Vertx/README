...
# Solution
I attack the problems by creating two separate projects provided I can´t find a project with reasonably close approximation to what I´m trying to do.
So, in this case I would solve (1) and (2) before putting them together.
